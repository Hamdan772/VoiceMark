...
export default function CoachPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(14,116,144,0.12),_transparent_32%),radial-gradient(circle_at_top_right,_rgba(99,102,241,0.08),_transparent_28%),linear-gradient(to_bottom,_color-mix(in_oklch,var(--background)_92%,white),_var(--background))]">
      ...
      <header className="sticky top-0 z-20 w-full border-b border-border/40 bg-background/55 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-5">
          <Link href="/" className="flex items-center gap-3 rounded-xl p-1 transition-colors hover:bg-secondary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
            ...
            <div className="text-left">
              <p className="text-base font-extrabold leading-none tracking-tight text-foreground">VoiceMark</p>
              <p className="mt-1 text-[10px] font-bold uppercase tracking-[0.24em] text-muted-foreground">AI Speech Coach</p>
            </div>
          </Link>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-8 px-5 py-8 lg:py-10">
        <section className="grid gap-4 rounded-[28px] border border-border bg-card/90 p-6 shadow-[0_20px_70px_-40px_rgba(0,0,0,0.35)] backdrop-blur lg:grid-cols-[1.15fr_0.85fr] lg:p-8">
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <h1 className="max-w-3xl text-3xl font-extrabold tracking-tight text-balance text-foreground md:text-5xl">
