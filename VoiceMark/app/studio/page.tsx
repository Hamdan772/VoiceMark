...
export default function StudioPage() {
    ...
    return (
        <main className="min-h-screen flex flex-col">
            ...
            <div className="flex-1 w-full max-w-5xl mx-auto px-5 py-10 flex flex-col gap-12">
                {/* ── Initial Record View ─────────────────────────────────────── */}
                {appState.phase === 'idle' && (
                    <section className="flex flex-col items-center gap-10">
                        ...
                        <FlowPath
                            ...
                            steps={[
                                ...
                                { label: 'Pick a script', href: '/script', description: 'Prepare the prompt or template.' },
                                { label: 'Practice in studio', href: '/studio', description: 'Record, analyze, and retry.' },
                        ...
                        <div className="grid w-full max-w-4xl gap-4 md:grid-cols-3">
                            <Link
                                href="/modes"
                                className="rounded-2xl border border-border bg-card p-5 text-left shadow-sm transition-colors hover:bg-muted/60"
                            >
            ...
            <footer className="border-t border-border py-5 mt-auto">
                <div className="flex flex-col items-center gap-2 text-xs text-muted-foreground">
                    <p>VoiceMark · No audio stored, ever. · Transcription powered by Groq Whisper</p>
