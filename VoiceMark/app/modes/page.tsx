                    ...
                    {USE_CASE_MODES.map((mode) => (
                        <button
                          ...
                          onClick={() => handleSelect(mode.id)}
                                                    className={`rounded-3xl border bg-card/70 p-6 text-left transition-all hover:-translate-y-0.5 hover:shadow-sm ${session.mode === mode.id ? 'border-primary ring-2 ring-primary/10' : 'border-border'}`}
                        >
                            ...
                            <div className="mt-4 rounded-2xl border border-border bg-background/70 p-4">
                                        ...
                                        {[
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`rounded-2xl border p-4 text-left transition-all hover:-translate-y-0.5 hover:shadow-sm ${active ? 'border-primary bg-primary/6' : 'border-border bg-background/80'}`}
                                                >
                                ...
                                <div className="mt-6 flex flex-wrap items-center justify-between gap-3 rounded-3xl border border-border bg-card/70 p-5">
                                    <div>
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50 btn-press"
                                    >
                                        Continue to script
                                    </button>
                                </div>
